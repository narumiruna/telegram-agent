import { FirecrawlApiKeyNotSetError, LoaderContentError, LoaderTimeoutError } from "../core/errors.js";
...
export class FirecrawlLoader implements Loader {
  ...
  async load(url: string, signal?: AbortSignal): Promise<string> {
    ...
    try {
      ...
      if (timeoutSignal.aborted) throw new LoaderTimeoutError("FirecrawlLoader", url, this.timeoutMs / 1_000);
      throw error;
    }
  }
}
